...
**To run the self-driving virtual laboratory for architected materials design using DANTE, see `DOTS_VL_Architected_Materials_Design.ipynb` for detailed instruction**
