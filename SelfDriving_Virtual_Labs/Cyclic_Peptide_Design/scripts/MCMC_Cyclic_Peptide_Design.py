# MCMC design based on Colabdesign
import numpy as np
import random
import warnings
...
pdb = '4ib5.pdb' # Define the pdb file here.
...
def _design_mcmc(init_seq, steps=1000, half_life=200, T_init=0.01, mutation_rate=1,
    ...
    for i in range(steps):
        ...
        # get loss
        values, aux = get_value(seq_folder, mut_seq, pdb)
...
seq_init = [random.randint(0, 19) for _ in range(seq_len)] # random start sequence
