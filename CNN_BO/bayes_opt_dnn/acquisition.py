...
from bayes_opt_dnn.exception import (
...
class AcquisitionFunction(abc.ABC):
    ...
    def _fit_gp(self, gp: Optional[CNNRegressor], target_space: TargetSpace) -> None:
    ...
    def _get_acq(
        self, gp: Optional[CNNRegressor], constraint: ConstraintModel | None = None
...
class GPHedge(AcquisitionFunction):
    ...
    def _update_gains(self, gp: Optional[CNNRegressor]) -> None:
